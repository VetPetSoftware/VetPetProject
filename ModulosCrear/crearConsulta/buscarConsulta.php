...
<body class="agrupar">
    ...
    <div class="seccion-buscar">
         ...
         <div class="seccion-botones">
             ...
             <div class="btn2">
                 <form action="nuevaConsulta.php" method="POST">
         ...
         <div>
             ...
             <table class="tabla">
                 ...
                 <tr class="primaFila"><!--fila-->
                          ...
                          <th class="fecha">Fecha</th><!--columna-->
                          <th class="hora">Hora</th><!--columna-->
                          <th class="paciente">Paciente</th><!--columna-->
                          <th class="estado">Estado</th><!--columna-->
                          <th class="raza">Raza</th><!--columna-->
                          <th class="medico">Médico</th><!--columna-->
                          <th class="motivo">Motivo Consulta</th><!--columna-->
                          <th class="estado">Estado Consulta</th><!--columna-->
                 ...
                 <?php
                     ...
                     while ($dato=$registros->fetch_assoc()) { ?>
                         ...
                         <tr class="fila"><!--fila-->
                              ...
                              <td name="tdFecha"><?php echo $dato['fecCon']; ?></td><!--columna-->
                              <td name="horCon"><?php echo $dato['horCon']; ?></td><!--columna-->
                              <td name="tdPaciente"><?php echo $dato['nomPac']; ?></td><!--columna-->
                              <td name="tdEspecie"><?php echo $dato['espPac']; ?></td><!--columna-->
                              <td name="tdRaza"><?php echo $dato['razPac']; ?></td><!--columna-->
                              <td name="tdMedico"><?php echo $dato['medico']; ?></td><!--columna-->
                              <td name="tdMotivo"><?php echo $dato['motivo']; ?></td><!--columna-->
                              <td name="tdEstado"><?php echo $dato['estado']; ?></td><!--columna-->
                              ...
                              <input type="hidden" name="oculto" value="1">
                                 ...
                                 <form action="" method="POST">
                                     ...
                                     <a href="visualizarConsulta.php?hisCli=<?php echo $dato['hisCli'];?>">
                                 ...
                                 <form action="" method="POST">
                                    ...
                                    <a href="editarConsulta.php?hisCli=<?php echo $dato['hisCli'];?>">
                                 ...
                                 <form action="" method="POST">
                                     ...
                                     <a href="agregarConsulta.php?hisCli=<?php echo $dato['hisCli'];?>">
         ...
         <div class="alert-editar-pop-up">
             ...
             <div class="alert-editar-pop-wrap">
                     ...
                     <div class="contenedor-inactivar-pac-btns">
                             ...
                             <form action="editarConsulta.php?hisCli=<?php echo $dato['hisCli'];?>" method="GET">
