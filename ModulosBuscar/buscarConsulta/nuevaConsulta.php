...
<!----------3. NUEVO PROPIETARIO - CONTENEDOR PROPIETARIO"---------->
                                            ...
                                            <h2>Datos Propietario</h2>
                                                        ...
                                                        <div class="contenedor-infopropietario-vis-pac">  
                                                            ...
                                                            <div class="campo2">
                                                                ...
                                                                <select class="selector" name="tipDoc" id="tipDoc">
                                                                <option value = "-1" disabled="disabled">Seleccionar especie</option>

                                                                <?php
                                                                    require_once 'conexion.php';

                                                                    $consulta = "SELECT * FROM documento ORDER BY tipoDoc";
                                                                    $resultado = $mysqli->query($consulta) or die (mysqli_error($mysqli));
                                                                    
                                                                    while($documento = mysqli_fetch_array($resultado)) { ?>
                                                                    <option value="<?php echo $documento['tipoDoc']; ?>"><?php echo $documento['tipoDoc']; ?></option>
                                                                    <?php }
                                                                ?>
...
<!----------3. NUEVO PROPIETARIO - CONTENEDOR PACIENTE"---------->
                                                ...
                                                <div class="contenedor-infopaciente-vis-pac">   
                                                            ...
                                                            <div class="campo1">
                                                                ...
                                                                <?php
                                                                        ...
                                                                        $sentencia = "SELECT * FROM especie ORDER BY lisEsp";
