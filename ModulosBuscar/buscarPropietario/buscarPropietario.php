...
<body class="agrupar">
    ...
    <div class="seccion-buscar">
         ...
         <div class="seccion-botones">
             ...
             <div class="btn2">
                 <form action="nuevoPropietario.php" method="POST">
                         ...
                         <tr class="fila"><!--fila-->
                              ...
                              <input type="hidden" name="oculto" value="1">
                                 ...
                                 <form action="" method="POST">
                                     ...
                                     <a href="visualizarPropietario.php?hisCli=<?php echo $dato['hisCli'];?>">
                                 ...
                                 <form action="" method="POST">
                                    ...
                                    <a href="editarPropietario.php?hisCli=<?php echo $dato['hisCli'];?>">
         ...
         <div class="alert-editar-pop-up">
             ...
             <div class="alert-editar-pop-wrap">
                     ...
                     <div class="contenedor-inactivar-pac-btns">
                             ...
                             <form action="editarPropietario.php?hisCli=<?php echo $dato['hisCli'];?>" method="GET">
